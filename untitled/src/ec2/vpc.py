class VPC:
    ...
    def attach_igw_to_vpc(self, vpc_id, igw_id):
        print('Attaching Internet Gateway to the VPC')
    ...
    def allow_auto_assign_public_ips_for_addresses(self, subnet_id):
